...
class Cablerow extends StatefulWidget {
  const Cablerow({super.key});

  @override
  _CableRowScreenState createState() => _CableRowScreenState();
}

class _CableRowScreenState extends State<Cablerow> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 15),
            const Text(
              "Sets: 3 | Reps: 8 | Weight: 55 lbs",
              style: TextStyle(color: Colors.white, fontSize: 18),
            ),
            const SizedBox(height: 15),
            const Text(
              "Cable Row targets your back muscles and helps improve posture and strength.",
